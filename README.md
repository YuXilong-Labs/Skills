...
./install.sh symbol-reference-scan
```
...
/symbol-reference-scan keywords=FeatureX,FeatureY mode=batch output_file=ref.md
...
/symbol-reference-scan 帮我查一下 FeatureX 在工程里哪些地方用到了，包括二进制 framework
```
